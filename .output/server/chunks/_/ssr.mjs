  ...
  return createServerFnStaticCache({
    getItem: async (ctx) => {
      if (typeof document === "undefined") {
        ...
        const publicUrl = "/Users/anilbobba/Desktop/Projects/NewTanstackVersion/.output/public";
        const {
          promises: fs2
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-0PXYcbIk.mjs');
    case VIRTUAL_MODULES.serverFnManifest:
      return await import('./_tanstack-start-server-fn-manifest_v-BbZ4E9ff.mjs');
    default:
...
const $$splitComponentImporter = () => import('./index-j9e72vgJ.mjs');
